...
// Histórico de rodadas encerradas (para a tela Home)
...
export const mockPlayers = [
  ...
  { id: 'u19', nome: 'Leonardo Barbosa',  email: 'leonardo@mock.com', rating: 2.2, gols: 1,  assistencias: 0,  jogos: 6,  foto_url: null, papel: 'usuario', status: 'aprovado' },
...
// 12 na lista principal (mix pago/confirmado), 3 na fila
export const mockPresencas = [
  { id: 'pr01', rodada_id: 'mock-rodada-1', usuario_id: 'u01', posicao: 1,  status: 'pago',       profiles: mockPlayers[0]  },
  { id: 'pr02', rodada_id: 'mock-rodada-1', usuario_id: 'u02', posicao: 2,  status: 'pago',       profiles: mockPlayers[1]  },
  { id: 'pr03', rodada_id: 'mock-rodada-1', usuario_id: 'u03', posicao: 3,  status: 'pago',       profiles: mockPlayers[2]  },
  { id: 'pr04', rodada_id: 'mock-rodada-1', usuario_id: 'u04', posicao: 4,  status: 'pago',       profiles: mockPlayers[3]  },
  { id: 'pr05', rodada_id: 'mock-rodada-1', usuario_id: 'u05', posicao: 5,  status: 'pago',       profiles: mockPlayers[4]  },
  { id: 'pr06', rodada_id: 'mock-rodada-1', usuario_id: 'u06', posicao: 6,  status: 'confirmado', profiles: mockPlayers[5]  },
  { id: 'pr07', rodada_id: 'mock-rodada-1', usuario_id: 'u07', posicao: 7,  status: 'confirmado', profiles: mockPlayers[6]  },
  { id: 'pr08', rodada_id: 'mock-rodada-1', usuario_id: 'u08', posicao: 8,  status: 'confirmado', profiles: mockPlayers[7]  },
  { id: 'pr09', rodada_id: 'mock-rodada-1', usuario_id: 'u09', posicao: 9,  status: 'confirmado', profiles: mockPlayers[8]  },
  { id: 'pr10', rodada_id: 'mock-rodada-1', usuario_id: 'u10', posicao: 10, status: 'confirmado', profiles: mockPlayers[9]  },
  { id: 'pr11', rodada_id: 'mock-rodada-1', usuario_id: 'u11', posicao: 11, status: 'confirmado', profiles: mockPlayers[10] },
  { id: 'pr12', rodada_id: 'mock-rodada-1', usuario_id: 'u12', posicao: 12, status: 'confirmado', profiles: mockPlayers[11] },
  { id: 'pr13', rodada_id: 'mock-rodada-1', usuario_id: 'u13', posicao: 21, status: 'espera',     profiles: mockPlayers[12] },
  { id: 'pr14', rodada_id: 'mock-rodada-1', usuario_id: 'u14', posicao: 22, status: 'espera',     profiles: mockPlayers[13] },
  { id: 'pr15', rodada_id: 'mock-rodada-1', usuario_id: 'u15', posicao: 23, status: 'espera',     profiles: mockPlayers[14] },
]
